...
{
    [DbContext(typeof(fraudwall_backofficeDbContext))]
    [Migration("20220920164716_modify_investigation")]
    partial class modify_investigation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fraudwall_backoffice.Comment.InvestigationComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppInvestigationComments", (string)null);
                });

            modelBuilder.Entity("fraudwall_backoffice.Fraud.FraudNumber", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFraudNumbers", (string)null);
                });

            modelBuilder.Entity("fraudwall_backoffice.Investigation.ReportInvestigation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppReportInvestigations", (string)null);
                });
            ...
            modelBuilder.Entity("fraudwall_backoffice.Comment.InvestigationComment", b =>
                {
                    b.HasOne("fraudwall_backoffice.Investigation.ReportInvestigation", null)
                        .WithMany()
