...
public static class fraudwall_backofficeEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE fraudwall_backofficeModuleExtensionConfigurator CLASS (in the Domain.Shared project)
